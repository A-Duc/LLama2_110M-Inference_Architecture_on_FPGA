...
set name kernel_matmul_fadd_32ns_32ns_32_2_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fadd} IMPL {fabric} LATENCY 1 ALLOW_PRAGMA 1
}


set name kernel_matmul_fmul_32ns_32ns_32_2_max_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename vec_local \
    op interface \
    ports { vec_local_address0 { O 10 vector } vec_local_ce0 { O 1 bit } vec_local_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_select_ln17_1 \
    op interface \
    ports { select_ln17_1 { I 32 vector } } \
} "
}
...
set InstName kernel_matmul_flow_control_loop_pipe_sequential_init_U
set CompName kernel_matmul_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix kernel_matmul_ \
}"
} else {
