set moduleName kernel_matmul_Pipeline_VITIS_LOOP_17_1
set isTopModule 0
...
set cdfgNum 5
set C_modelName {kernel_matmul_Pipeline_VITIS_LOOP_17_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict vec_local { MEM_WIDTH 32 MEM_SIZE 3072 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem0 int 32 regular {axi_master 0}  }
	{ select_ln17_1 int 32 regular  }
	{ i_vec int 64 regular  }
	{ vec_local float 32 regular {array 768 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "i_vec","offset": { "type": "dynamic","port_name": "i_vec","bundle": "control"},"direction": "READONLY"},{"cName": "o_vec","offset": { "type": "dynamic","port_name": "o_vec","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "select_ln17_1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ select_ln17_1 sc_in sc_lv 32 signal 1 } 
	{ i_vec sc_in sc_lv 64 signal 2 } 
	{ vec_local_address0 sc_out sc_lv 10 signal 3 } 
	{ vec_local_ce0 sc_out sc_logic 1 signal 3 } 
	{ vec_local_we0 sc_out sc_logic 1 signal 3 } 
	{ vec_local_d0 sc_out sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "select_ln17_1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "select_ln17_1", "role": "default" }} , 
 	{ "name": "i_vec", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "i_vec", "role": "default" }} , 
 	{ "name": "vec_local_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "vec_local", "role": "address0" }} , 
 	{ "name": "vec_local_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "vec_local", "role": "ce0" }} , 
 	{ "name": "vec_local_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "vec_local", "role": "we0" }} , 
 	{ "name": "vec_local_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "vec_local", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	select_ln17_1 { ap_none {  { select_ln17_1 in_data 0 32 } } }
	i_vec { ap_none {  { i_vec in_data 0 64 } } }
	vec_local { ap_memory {  { vec_local_address0 mem_address 1 10 }  { vec_local_ce0 mem_ce 1 1 }  { vec_local_we0 mem_we 1 1 }  { vec_local_d0 mem_din 1 32 } } }
}
