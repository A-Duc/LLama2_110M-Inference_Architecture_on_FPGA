...
void llama_inference_hls_top(
    ...
    // KV Cache for autoregressive generation - OPTIMIZED WITH URAM
    float* k_cache,            // [kNumLayers][kSeqLen][kDim] - Use URAM for bandwidth
    float* v_cache,            // [kNumLayers][kSeqLen][kDim] - Use URAM for bandwidth
