...
module kernel_mhsa_load_mat_Pipeline_mem_rd_VITIS_LOOP_25_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [19:0] indvar_flatten_fu_56;
wire   [19:0] add_ln23_fu_91_p2;
wire    ap_loop_init;
reg    ap_block_pp0_stage0_11001;
reg   [19:0] ap_sig_allocacmp_indvar_flatten_load;
wire    ap_block_pp0_stage0;
reg    ap_block_pp0_stage0_01001_grp1;
reg    matrix_stream_write_local;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln23_fu_97_p2 == 1'd0))) begin
            indvar_flatten_fu_56 <= add_ln23_fu_91_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten_fu_56 <= 20'd0;
        end
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln23_fu_97_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        matrix_stream_write_local = 1'b1;
    end else begin
        matrix_stream_write_local = 1'b0;
    end
end
...
assign add_ln23_fu_91_p2 = (ap_sig_allocacmp_indvar_flatten_load + 20'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp1 = ((matrix_stream_full_n == 1'b0) | (m_axi_gmem1_0_RVALID == 1'b0));
end
...
assign icmp_ln23_fu_97_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 20'd589824) ? 1'b1 : 1'b0);
...
assign matrix_stream_din = m_axi_gmem1_0_RDATA;

assign matrix_stream_write = matrix_stream_write_local;

endmodule //kernel_mhsa_load_mat_Pipeline_mem_rd_VITIS_LOOP_25_1
