...
entity kernel_mhsa_fifo_w64_d2_S is 
    generic (
...
architecture rtl of kernel_mhsa_fifo_w64_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component kernel_mhsa_fifo_w64_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_kernel_mhsa_fifo_w64_d2_S_ShiftReg : kernel_mhsa_fifo_w64_d2_S_ShiftReg
    generic map (
...
entity kernel_mhsa_fifo_w64_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end kernel_mhsa_fifo_w64_d2_S_ShiftReg;

architecture rtl of kernel_mhsa_fifo_w64_d2_S_ShiftReg is
