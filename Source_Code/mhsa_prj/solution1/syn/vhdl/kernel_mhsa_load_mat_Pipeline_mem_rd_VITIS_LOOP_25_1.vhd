...
entity kernel_mhsa_load_mat_Pipeline_mem_rd_VITIS_LOOP_25_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of kernel_mhsa_load_mat_Pipeline_mem_rd_VITIS_LOOP_25_1 is 
...
attribute shreg_extract : string;
    ...
    signal indvar_flatten_fu_56 : STD_LOGIC_VECTOR (19 downto 0) := "00000000000000000000";
    signal add_ln23_fu_91_p2 : STD_LOGIC_VECTOR (19 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal ap_sig_allocacmp_indvar_flatten_load : STD_LOGIC_VECTOR (19 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal ap_block_pp0_stage0_01001_grp1 : BOOLEAN;
    signal matrix_stream_write_local : STD_LOGIC;
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln23_fu_97_p2 = ap_const_lv1_0))) then 
                    indvar_flatten_fu_56 <= add_ln23_fu_91_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    indvar_flatten_fu_56 <= ap_const_lv20_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln23_fu_91_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten_load) + unsigned(ap_const_lv20_1));
    ...
    ap_block_state2_pp0_stage0_iter1_grp1_assign_proc : process(m_axi_gmem1_0_RVALID, matrix_stream_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1_grp1 <= ((matrix_stream_full_n = ap_const_logic_0) or (m_axi_gmem1_0_RVALID = ap_const_logic_0));
    end process;
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln23_fu_97_p2 = ap_const_lv1_1))) then 
    ...
    ap_sig_allocacmp_indvar_flatten_load_assign_proc : process(ap_CS_fsm_pp0_stage0, indvar_flatten_fu_56, ap_loop_init, ap_block_pp0_stage0)
    begin
    ...
    icmp_ln23_fu_97_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten_load = ap_const_lv20_90000) else "0";
    ...
    matrix_stream_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, matrix_stream_full_n, ap_block_pp0_stage0_grp1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_grp1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            matrix_stream_blk_n <= matrix_stream_full_n;
        else 
            matrix_stream_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    matrix_stream_din <= m_axi_gmem1_0_RDATA;
    matrix_stream_write <= matrix_stream_write_local;

    matrix_stream_write_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001_grp1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            matrix_stream_write_local <= ap_const_logic_1;
        else 
            matrix_stream_write_local <= ap_const_logic_0;
        end if; 
    end process;
