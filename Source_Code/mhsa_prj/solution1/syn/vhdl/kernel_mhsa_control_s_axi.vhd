...
end entity kernel_mhsa_control_s_axi;
...
architecture behave of kernel_mhsa_control_s_axi is
    ...
    constant ADDR_CURRENT_TOKEN_DATA_0 : INTEGER := 16#10#;
    constant ADDR_CURRENT_TOKEN_DATA_1 : INTEGER := 16#14#;
    ...
    constant ADDR_KEY_CACHE_DATA_0     : INTEGER := 16#30#;
    constant ADDR_KEY_CACHE_DATA_1     : INTEGER := 16#34#;
    constant ADDR_KEY_CACHE_CTRL       : INTEGER := 16#38#;
    constant ADDR_VALUE_CACHE_DATA_0   : INTEGER := 16#3c#;
    constant ADDR_VALUE_CACHE_DATA_1   : INTEGER := 16#40#;
    constant ADDR_VALUE_CACHE_CTRL     : INTEGER := 16#44#;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_CURRENT_TOKEN_DATA_0 =>
                        rdata_data <= RESIZE(int_current_token(31 downto 0), 32);
                    when ADDR_CURRENT_TOKEN_DATA_1 =>
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_current_token(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURRENT_TOKEN_DATA_0) then
                    int_current_token(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_current_token(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_current_token(63 downto 32) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURRENT_TOKEN_DATA_1) then
                    int_current_token(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_current_token(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_position(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
