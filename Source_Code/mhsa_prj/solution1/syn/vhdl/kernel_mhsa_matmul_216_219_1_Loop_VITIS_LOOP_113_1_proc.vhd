...
entity kernel_mhsa_matmul_216_219_1_Loop_VITIS_LOOP_113_1_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of kernel_mhsa_matmul_216_219_1_Loop_VITIS_LOOP_113_1_proc is 
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                lshr_ln_reg_588 <= ap_sig_allocacmp_i_1(9 downto 4);
    ...
    add_ln113_fu_403_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv10_1));
    ...
    ap_sig_allocacmp_i_1_assign_proc : process(ap_CS_fsm_pp0_stage0, i_fu_110, ap_loop_init, ap_block_pp0_stage0, ap_start_int)
    begin
    ...
    icmp_ln113_fu_409_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv10_300) else "0";
    ...
    trunc_ln113_fu_415_p1 <= ap_sig_allocacmp_i_1(4 - 1 downto 0);
