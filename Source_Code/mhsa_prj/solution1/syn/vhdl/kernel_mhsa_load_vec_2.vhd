...
entity kernel_mhsa_load_vec_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of kernel_mhsa_load_vec_2 is 
...
attribute shreg_extract : string;
    ...
    signal vec_read_reg_242 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal trunc_ln15_fu_206_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_block_state14 : BOOLEAN;
    signal add_ln15_3_fu_214_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal add5_in_reg_110 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal icmp_ln13_fu_138_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln15_fu_219_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal j_reg_119 : STD_LOGIC_VECTOR (3 downto 0);
    signal sext_ln17_fu_171_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_fu_80 : STD_LOGIC_VECTOR (9 downto 0) := "0000000000";
    signal add_ln13_fu_225_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal vec_stream_write_local : STD_LOGIC;
    signal shl_ln_fu_144_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal zext_ln17_fu_152_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln17_fu_156_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln_fu_161_p4 : STD_LOGIC_VECTOR (61 downto 0);
    signal zext_ln15_fu_190_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln15_fu_200_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal zext_ln15_4_fu_210_p1 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln13_fu_138_p2 = ap_const_lv1_0))) then 
    ...
    add5_in_reg_110_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state14) and (icmp_ln15_fu_219_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_state14))) then 
                add5_in_reg_110 <= add_ln15_3_fu_214_p2;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln13_fu_138_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
                i_fu_80 <= ap_const_lv10_0;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state14) and (icmp_ln15_fu_219_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_state14))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem0_0_ARREADY, ap_CS_fsm_state3, ap_CS_fsm_state14, ap_block_state1, ap_block_state14, ap_CS_fsm_state2, icmp_ln13_fu_138_p2, icmp_ln15_fu_219_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln13_fu_138_p2 = ap_const_lv1_0))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
            ...
            when ap_ST_fsm_state14 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state14) and (icmp_ln15_fu_219_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_state14))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state14) and (icmp_ln15_fu_219_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_state14))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                else
                    ap_NS_fsm <= ap_ST_fsm_state14;
                end if;
    ...
    add_ln13_fu_225_p2 <= std_logic_vector(unsigned(i_fu_80) + unsigned(ap_const_lv10_10));
    add_ln15_3_fu_214_p2 <= std_logic_vector(unsigned(i_fu_80) + unsigned(zext_ln15_4_fu_210_p1));
    add_ln15_fu_200_p2 <= std_logic_vector(unsigned(zext_ln15_fu_190_p1) + unsigned(ap_const_lv5_1));
    add_ln17_fu_156_p2 <= std_logic_vector(unsigned(zext_ln17_fu_152_p1) + unsigned(vec_read_reg_242));
    ...
    ap_block_state14_assign_proc : process(m_axi_gmem0_0_RVALID, vec_stream_full_n)
    begin
                ap_block_state14 <= ((m_axi_gmem0_0_RVALID = ap_const_logic_0) or (vec_stream_full_n = ap_const_logic_0));
    end process;


    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state2, icmp_ln13_fu_138_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln13_fu_138_p2 = ap_const_lv1_0))) then 
    ...
    gmem0_blk_n_R_assign_proc : process(m_axi_gmem0_0_RVALID, ap_CS_fsm_state14)
    begin
    ...
    icmp_ln13_fu_138_p2 <= "1" when (unsigned(i_fu_80) < unsigned(ap_const_lv10_300)) else "0";
    icmp_ln15_fu_219_p2 <= "1" when (add_ln15_fu_200_p2 = ap_const_lv5_10) else "0";

    internal_ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln13_fu_138_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln13_fu_138_p2 = ap_const_lv1_0))) then 
    ...
    m_axi_gmem0_0_ARADDR <= sext_ln17_fu_171_p1;
    ...
    m_axi_gmem0_0_ARVALID_assign_proc : process(m_axi_gmem0_0_ARREADY, ap_CS_fsm_state3)
    begin
        if (((m_axi_gmem0_0_ARREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    m_axi_gmem0_0_RREADY_assign_proc : process(ap_CS_fsm_state14, ap_block_state14)
    begin
    ...
    begin
        ...
        sext_ln17_fu_171_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_fu_161_p4),64));

    shl_ln_fu_144_p3 <= (add5_in_reg_110 & ap_const_lv2_0);
    ...
    trunc_ln15_fu_206_p1 <= add_ln15_fu_200_p2(4 - 1 downto 0);
    trunc_ln_fu_161_p4 <= add_ln17_fu_156_p2(63 downto 2);

    vec_stream_blk_n_assign_proc : process(vec_stream_full_n, ap_CS_fsm_state14)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state14)) then 
    ...
    vec_stream_din <= m_axi_gmem0_0_RDATA;
    vec_stream_write <= vec_stream_write_local;

    vec_stream_write_local_assign_proc : process(ap_CS_fsm_state14, ap_block_state14)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state14) and (ap_const_boolean_0 = ap_block_state14))) then 
    ...
    zext_ln15_4_fu_210_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln15_fu_200_p2),10));
    zext_ln15_fu_190_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_reg_119),5));
    zext_ln17_fu_152_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln_fu_144_p3),64));
end behav;
