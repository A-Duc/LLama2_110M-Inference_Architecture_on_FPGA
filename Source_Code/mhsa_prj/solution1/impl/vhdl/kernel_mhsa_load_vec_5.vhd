...
entity kernel_mhsa_load_vec_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of kernel_mhsa_load_vec_5 is 
...
attribute shreg_extract : string;
    ...
    signal add_ln15_2_fu_214_p2 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal zext_ln15_3_fu_210_p1 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state14) and (icmp_ln15_fu_219_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_state14))) then 
                add5_in_reg_110 <= add_ln15_2_fu_214_p2;
    ...
    add_ln15_2_fu_214_p2 <= std_logic_vector(unsigned(i_fu_80) + unsigned(zext_ln15_3_fu_210_p1));
    ...
    zext_ln15_3_fu_210_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln15_fu_200_p2),10));
