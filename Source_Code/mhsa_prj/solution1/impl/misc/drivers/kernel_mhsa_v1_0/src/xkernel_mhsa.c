...
void XKernel_mhsa_Set_weights(XKernel_mhsa *InstancePtr, u64 Data) {
    ...
    XKernel_mhsa_WriteReg(InstancePtr->Control_BaseAddress, XKERNEL_MHSA_CONTROL_ADDR_WEIGHTS_DATA, (u32)(Data));
    XKernel_mhsa_WriteReg(InstancePtr->Control_BaseAddress, XKERNEL_MHSA_CONTROL_ADDR_WEIGHTS_DATA + 4, (u32)(Data >> 32));
}
...
u64 XKernel_mhsa_Get_weights(XKernel_mhsa *InstancePtr) {
    ...
    Data = XKernel_mhsa_ReadReg(InstancePtr->Control_BaseAddress, XKERNEL_MHSA_CONTROL_ADDR_WEIGHTS_DATA);
    Data += (u64)XKernel_mhsa_ReadReg(InstancePtr->Control_BaseAddress, XKERNEL_MHSA_CONTROL_ADDR_WEIGHTS_DATA + 4) << 32;
    return Data;
}
