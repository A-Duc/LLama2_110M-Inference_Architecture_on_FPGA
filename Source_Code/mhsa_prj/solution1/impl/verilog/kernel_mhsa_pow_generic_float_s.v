...
module kernel_mhsa_pow_generic_float_s (
        ap_clk,
        ap_rst,
        exp,
        ap_return
...
kernel_mhsa_mul_25s_39ns_63_1_1 #(
    ...
    .din1_WIDTH( 39 ),
    .dout_WIDTH( 63 ))
mul_25s_39ns_63_1_1_U328(
    .din0(e_frac_2_reg_998),
    .din1(m_frac_l_fu_207_p1),
    .dout(m_frac_l_fu_207_p2)
);

(* dissolve_hierarchy = "yes" *) kernel_mhsa_sparsemux_11_4_32_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 4'h8 ),
    .din0_WIDTH( 32 ),
...
kernel_mhsa_mac_muladd_13s_12ns_16s_25_4_1 #(
    ...
    .din2_WIDTH( 16 ),
    .dout_WIDTH( 25 ))
mac_muladd_13s_12ns_16s_25_4_1_U330(
    .clk(ap_clk),
    .reset(ap_rst),
...
kernel_mhsa_mac_muladd_18ns_18ns_44ns_44_4_1 #(
    ...
    .din2_WIDTH( 44 ),
    .dout_WIDTH( 44 ))
mac_muladd_18ns_18ns_44ns_44_4_1_U331(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_962_p0),
    .din1(grp_fu_962_p1),
...
endmodule //kernel_mhsa_pow_generic_float_s
