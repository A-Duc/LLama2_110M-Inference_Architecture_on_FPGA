...
set cdfgNum 53
set C_modelName {load_vec.5}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem0 int 32 regular {axi_master 0 stable }  }
	{ vec int 64 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "current_token","offset": { "type": "dynamic","port_name": "current_token","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "vec", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ vec sc_in sc_lv 64 signal 1 } 
	{ vec_stream_din sc_out sc_lv 32 signal 2 } 
	{ vec_stream_full_n sc_in sc_logic 1 signal 2 } 
	{ vec_stream_write sc_out sc_logic 1 signal 2 } 
	{ vec_stream_num_data_valid sc_in sc_lv 8 signal 2 } 
	{ vec_stream_fifo_cap sc_in sc_lv 8 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "vec", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "vec", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "9265", "Max" : "9265"}
	, {"Name" : "Interval", "Min" : "9265", "Max" : "9265"}
]}
...
set Spec2ImplPortList { 
	...
	vec { ap_stable {  { vec in_data 0 64 } } }
