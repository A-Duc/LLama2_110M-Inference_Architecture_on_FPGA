...
entity kernel_mhsa_facc_32ns_32ns_1ns_32_2_primitive_dsp_1 is
   generic (
       ID         : integer := 1;
       NUM_STAGE  : integer := 1;
...
architecture arch of kernel_mhsa_facc_32ns_32ns_1ns_32_2_primitive_dsp_1 is
   component kernel_mhsa_facc_32ns_32ns_1ns_32_2_primitive_dsp_1_ip is
       port (
           aclk : in std_logic;
           aclken : in std_logic;
...
begin
   kernel_mhsa_facc_32ns_32ns_1ns_32_2_primitive_dsp_1_ip_u : component kernel_mhsa_facc_32ns_32ns_1ns_32_2_primitive_dsp_1_ip 
   port map (
       aclk => clk,
       aclken => ce,
