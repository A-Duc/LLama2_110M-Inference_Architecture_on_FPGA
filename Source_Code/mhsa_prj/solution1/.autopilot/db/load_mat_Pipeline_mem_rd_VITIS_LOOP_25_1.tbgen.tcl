set moduleName load_mat_Pipeline_mem_rd_VITIS_LOOP_25_1
set isTopModule 0
...
set cdfgNum 29
set C_modelName {load_mat_Pipeline_mem_rd_VITIS_LOOP_25_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem1 int 32 regular {axi_master 0 stable }  }
	{ sext_ln23 int 62 regular {ap_stable 0} }
...
set portList { 
	...
	{ matrix_stream_din sc_out sc_lv 32 signal 2 } 
	{ matrix_stream_full_n sc_in sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "matrix_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "matrix_stream", "role": "din" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "589826", "Max" : "589826"}
	, {"Name" : "Interval", "Min" : "589826", "Max" : "589826"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln23 { ap_stable {  { sext_ln23 in_data 0 62 } } }
