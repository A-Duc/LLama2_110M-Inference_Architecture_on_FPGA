...
set name kernel_mhsa_fmacc_32ns_32ns_32ns_1ns_32_2_primitive_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sum_local_out \
    op interface \
    ports { sum_local_out { O 32 vector } sum_local_out_ap_vld { O 1 bit } } \
} "
}
