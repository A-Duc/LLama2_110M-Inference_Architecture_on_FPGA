...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kernel_mhsa_fifo_w32_d128_A_x1 BINDTYPE {storage} TYPE {fifo} IMPL {memory} ALLOW_PRAGMA 1 INSTNAME {vec_stream_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kernel_mhsa_fifo_w32_d256_A_x1 BINDTYPE {storage} TYPE {fifo} IMPL {memory} ALLOW_PRAGMA 1 INSTNAME {mat_stream_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kernel_mhsa_fifo_w32_d64_A_x1 BINDTYPE {storage} TYPE {fifo} IMPL {memory} ALLOW_PRAGMA 1 INSTNAME {res_stream_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kernel_mhsa_start_for_compute_vec_mat_10_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_compute_vec_mat_10_U0_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kernel_mhsa_start_for_matmul_1_Loop_VITIS_LOOP_113_1_proc_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_matmul_1_Loop_VITIS_LOOP_113_1_proc_U0_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_gmem7 \
    op interface \
    ports { m_axi_gmem7_0_AWVALID { O 1 bit } m_axi_gmem7_0_AWREADY { I 1 bit } m_axi_gmem7_0_AWADDR { O 64 vector } m_axi_gmem7_0_AWID { O 1 vector } m_axi_gmem7_0_AWLEN { O 32 vector } m_axi_gmem7_0_AWSIZE { O 3 vector } m_axi_gmem7_0_AWBURST { O 2 vector } m_axi_gmem7_0_AWLOCK { O 2 vector } m_axi_gmem7_0_AWCACHE { O 4 vector } m_axi_gmem7_0_AWPROT { O 3 vector } m_axi_gmem7_0_AWQOS { O 4 vector } m_axi_gmem7_0_AWREGION { O 4 vector } m_axi_gmem7_0_AWUSER { O 1 vector } m_axi_gmem7_0_WVALID { O 1 bit } m_axi_gmem7_0_WREADY { I 1 bit } m_axi_gmem7_0_WDATA { O 32 vector } m_axi_gmem7_0_WSTRB { O 4 vector } m_axi_gmem7_0_WLAST { O 1 bit } m_axi_gmem7_0_WID { O 1 vector } m_axi_gmem7_0_WUSER { O 1 vector } m_axi_gmem7_0_ARVALID { O 1 bit } m_axi_gmem7_0_ARREADY { I 1 bit } m_axi_gmem7_0_ARADDR { O 64 vector } m_axi_gmem7_0_ARID { O 1 vector } m_axi_gmem7_0_ARLEN { O 32 vector } m_axi_gmem7_0_ARSIZE { O 3 vector } m_axi_gmem7_0_ARBURST { O 2 vector } m_axi_gmem7_0_ARLOCK { O 2 vector } m_axi_gmem7_0_ARCACHE { O 4 vector } m_axi_gmem7_0_ARPROT { O 3 vector } m_axi_gmem7_0_ARQOS { O 4 vector } m_axi_gmem7_0_ARREGION { O 4 vector } m_axi_gmem7_0_ARUSER { O 1 vector } m_axi_gmem7_0_RVALID { I 1 bit } m_axi_gmem7_0_RREADY { O 1 bit } m_axi_gmem7_0_RDATA { I 32 vector } m_axi_gmem7_0_RLAST { I 1 bit } m_axi_gmem7_0_RID { I 1 vector } m_axi_gmem7_0_RFIFONUM { I 13 vector } m_axi_gmem7_0_RUSER { I 1 vector } m_axi_gmem7_0_RRESP { I 2 vector } m_axi_gmem7_0_BVALID { I 1 bit } m_axi_gmem7_0_BREADY { O 1 bit } m_axi_gmem7_0_BRESP { I 2 vector } m_axi_gmem7_0_BID { I 1 vector } m_axi_gmem7_0_BUSER { I 1 vector } } \
} "
}
