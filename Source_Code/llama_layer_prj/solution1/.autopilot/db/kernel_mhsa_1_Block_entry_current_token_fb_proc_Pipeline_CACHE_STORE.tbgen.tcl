set moduleName kernel_mhsa_1_Block_entry_current_token_fb_proc_Pipeline_CACHE_STORE
set isTopModule 0
...
set cdfgNum 89
set C_modelName {kernel_mhsa.1_Block_entry_current_token_fb_proc_Pipeline_CACHE_STORE}
...
set C_modelArgList {
	...
	{ p_cast1_cast int 62 regular {ap_stable 0} }
	{ gmem4 int 32 regular {axi_master 1}  }
	{ p_cast_cast int 62 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem3", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "key_cache","offset": { "type": "dynamic","port_name": "key_cache","bundle": "control_r"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "p_cast1_cast", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "gmem4", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "value_cache","offset": { "type": "dynamic","port_name": "value_cache","bundle": "control_r"},"direction": "READWRITE"}]}]} , 
...
set portList { 
	...
	{ m_axi_gmem4_0_RFIFONUM sc_in sc_lv 13 signal 2 } 
	...
	{ sext_ln54 sc_in sc_lv 62 signal 4 } 
	{ sext_ln54_1 sc_in sc_lv 62 signal 5 } 
...
set Spec2ImplPortList { 
	...
	p_cast1_cast { ap_stable {  { p_cast1_cast in_data 0 62 } } }
	...
	p_cast_cast { ap_stable {  { p_cast_cast in_data 0 62 } } }
