...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler llama_layer_sparsemux_33_4_32_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {compactencoding_dontcare}
}


set name llama_layer_fmacc_32ns_32ns_32ns_1ns_32_2_primitive_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fmacc} IMPL {primitivedsp} LATENCY 1 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    id 23 \
    name sum_local_2_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_sum_local_2_out \
    op interface \
    ports { sum_local_2_out { O 32 vector } sum_local_2_out_ap_vld { O 1 bit } } \
} "
}
