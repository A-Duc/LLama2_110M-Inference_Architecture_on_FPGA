set moduleName matmul_1_Loop_VITIS_LOOP_112_1_proc_Pipeline_VITIS_LOOP_112_1
set isTopModule 0
...
set cdfgNum 89
set C_modelName {matmul.1_Loop_VITIS_LOOP_112_1_proc_Pipeline_VITIS_LOOP_112_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem1 int 32 regular {axi_master 1}  }
	{ sext_ln112 int 62 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_logits","offset": { "type": "dynamic","port_name": "output_logits","bundle": "control_r"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln112", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ res_stream_dout sc_in sc_lv 32 signal 2 } 
	{ res_stream_empty_n sc_in sc_logic 1 signal 2 } 
	{ res_stream_read sc_out sc_logic 1 signal 2 } 
	{ res_stream_num_data_valid sc_in sc_lv 7 signal 2 } 
	{ res_stream_fifo_cap sc_in sc_lv 7 signal 2 } 
	...
	{ sext_ln112 sc_in sc_lv 62 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln112", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln112", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln112 { ap_stable {  { sext_ln112 in_data 0 62 } } }
