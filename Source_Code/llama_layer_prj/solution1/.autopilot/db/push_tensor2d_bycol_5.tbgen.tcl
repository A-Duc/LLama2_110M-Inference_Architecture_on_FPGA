set moduleName push_tensor2d_bycol_5
set isTopModule 0
...
set cdfgNum 89
set C_modelName {push_tensor2d_bycol.5}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem2 int 32 regular {axi_master 0 stable }  }
	{ tsor int 64 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "all_weights","offset": { "type": "dynamic","port_name": "all_weights","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "tsor", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ W_strm_din sc_out sc_lv 32 signal 2 } 
	{ W_strm_full_n sc_in sc_logic 1 signal 2 } 
	{ W_strm_write sc_out sc_logic 1 signal 2 } 
	{ tsor sc_in sc_lv 64 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tsor", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "tsor", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2359310", "Max" : "2359310"}
	, {"Name" : "Interval", "Min" : "2359310", "Max" : "2359310"}
]}
...
set Spec2ImplPortList { 
	...
	tsor { ap_stable {  { tsor in_data 0 64 } } }
	W_strm { ap_fifo {  { W_strm_din fifo_data_in 1 32 }  { W_strm_full_n fifo_status 0 1 }  { W_strm_write fifo_port_we 1 1 } } }
}
