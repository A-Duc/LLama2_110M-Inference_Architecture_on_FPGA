...
entity llama_layer_fifo_w33_d2_S is 
    generic (
...
architecture rtl of llama_layer_fifo_w33_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component llama_layer_fifo_w33_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 33;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_llama_layer_fifo_w33_d2_S_ShiftReg : llama_layer_fifo_w33_d2_S_ShiftReg
    generic map (
...
entity llama_layer_fifo_w33_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 33;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end llama_layer_fifo_w33_d2_S_ShiftReg;

architecture rtl of llama_layer_fifo_w33_d2_S_ShiftReg is
