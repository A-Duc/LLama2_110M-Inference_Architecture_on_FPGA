...
module llama_layer_Multiply_VecMat_Pipeline_VITIS_LOOP_41_2_VITIS_LOOP_43_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (icmp_ln43_1_reg_250_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (icmp_ln43_1_reg_250_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        z1_strm_write_local = 1'b1;
    end else begin
        z1_strm_write_local = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state4_pp0_stage1_iter1 = ((icmp_ln43_1_reg_250_pp0_iter1_reg == 1'd1) & (z1_strm_full_n == 1'b0));
end
...
assign icmp_ln43_1_fu_157_p2 = ((add_ln43_fu_151_p2 == 10'd768) ? 1'b1 : 1'b0);

assign icmp_ln43_fu_128_p2 = ((ap_sig_allocacmp_j_load == 10'd768) ? 1'b1 : 1'b0);

assign local_vec_address0 = zext_ln43_fu_142_p1;

assign local_vec_ce0 = local_vec_ce0_local;

assign select_ln41_1_fu_176_p3 = ((icmp_ln43_reg_240[0:0] == 1'b1) ? 32'd0 : ap_sig_allocacmp_sum_load);

assign select_ln41_fu_134_p3 = ((icmp_ln43_fu_128_p2[0:0] == 1'b1) ? 10'd0 : ap_sig_allocacmp_j_load);

assign z1_strm_din = bitcast_ln46_fu_201_p1;

assign z1_strm_write = z1_strm_write_local;

assign zext_ln43_fu_142_p1 = select_ln41_fu_134_p3;

endmodule //llama_layer_Multiply_VecMat_Pipeline_VITIS_LOOP_41_2_VITIS_LOOP_43_3
