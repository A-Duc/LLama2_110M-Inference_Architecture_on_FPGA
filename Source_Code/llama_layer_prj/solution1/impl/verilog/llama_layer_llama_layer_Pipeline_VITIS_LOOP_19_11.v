...
module llama_layer_llama_layer_Pipeline_VITIS_LOOP_19_11 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
output  [31:0] sum_local_4_out;
output   sum_local_4_out_ap_vld;
...
wire   [6:0] lshr_ln18_2_fu_224_p4;
...
fmacc_32ns_32ns_32ns_1ns_32_2_primitive_dsp_1_U1387(
    .clk(ap_clk),
    .reset(ap_rst),
    .ce(1'b1),
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter2_reg == 1'b1) & (icmp_ln19_reg_358_pp0_iter1_reg == 1'd1))) begin
        sum_local_4_out_ap_vld = 1'b1;
    end else begin
        sum_local_4_out_ap_vld = 1'b0;
    end
end
...
assign layer_output_28_address0 = zext_ln18_fu_234_p1;

assign layer_output_28_ce0 = layer_output_28_ce0_local;

assign layer_output_29_address0 = zext_ln18_fu_234_p1;

assign layer_output_29_ce0 = layer_output_29_ce0_local;

assign layer_output_30_address0 = zext_ln18_fu_234_p1;

assign layer_output_30_ce0 = layer_output_30_ce0_local;

assign layer_output_31_address0 = zext_ln18_fu_234_p1;

assign layer_output_31_ce0 = layer_output_31_ce0_local;

assign layer_output_32_address0 = zext_ln18_fu_234_p1;

assign layer_output_32_ce0 = layer_output_32_ce0_local;

assign layer_output_33_address0 = zext_ln18_fu_234_p1;

assign layer_output_33_ce0 = layer_output_33_ce0_local;

assign layer_output_34_address0 = zext_ln18_fu_234_p1;

assign layer_output_34_ce0 = layer_output_34_ce0_local;

assign layer_output_address0 = zext_ln18_fu_234_p1;

assign layer_output_ce0 = layer_output_ce0_local;

assign lshr_ln18_2_fu_224_p4 = {{ap_sig_allocacmp_i[9:3]}};

assign sum_local_4_out = sum_local_fu_76;

assign trunc_ln19_fu_220_p1 = ap_sig_allocacmp_i[2:0];

assign v_fu_289_p17 = 'bx;

assign zext_ln18_fu_234_p1 = lshr_ln18_2_fu_224_p4;

endmodule //llama_layer_llama_layer_Pipeline_VITIS_LOOP_19_11
