...
module llama_layer_compute_vec_mat_15_Pipeline_VITIS_LOOP_48_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        lshr_ln_reg_588 <= {{ap_sig_allocacmp_i_21[9:4]}};
...
assign add_ln48_fu_403_p2 = (ap_sig_allocacmp_i_21 + 10'd1);
...
assign icmp_ln48_fu_409_p2 = ((ap_sig_allocacmp_i_21 == 10'd768) ? 1'b1 : 1'b0);

assign trunc_ln48_fu_415_p1 = ap_sig_allocacmp_i_21[3:0];
...
endmodule //llama_layer_compute_vec_mat_15_Pipeline_VITIS_LOOP_48_1
