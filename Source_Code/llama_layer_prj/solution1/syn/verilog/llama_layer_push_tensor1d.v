...
module llama_layer_push_tensor1d (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln12_fu_199_p2 = (ap_sig_allocacmp_i_2 + 10'd1);
...
assign icmp_ln12_fu_205_p2 = ((ap_sig_allocacmp_i_2 == 10'd768) ? 1'b1 : 1'b0);

assign lshr_ln_fu_215_p4 = {{ap_sig_allocacmp_i_2[9:3]}};

assign tmp_fu_274_p17 = 'bx;

assign trunc_ln12_fu_211_p1 = ap_sig_allocacmp_i_2[2:0];
...
endmodule //llama_layer_push_tensor1d
