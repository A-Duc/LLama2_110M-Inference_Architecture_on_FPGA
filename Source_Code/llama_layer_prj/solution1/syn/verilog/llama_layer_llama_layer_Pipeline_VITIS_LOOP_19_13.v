...
module llama_layer_llama_layer_Pipeline_VITIS_LOOP_19_13 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
fmacc_32ns_32ns_32ns_1ns_32_2_primitive_dsp_1_U1630(
    .clk(ap_clk),
    .reset(ap_rst),
    .ce(1'b1),
...
assign lshr_ln1_fu_368_p4 = {{ap_sig_allocacmp_i[9:4]}};
...
assign sum_local_out = sum_local_fu_116;

assign trunc_ln19_fu_364_p1 = ap_sig_allocacmp_i[3:0];

assign v_fu_473_p33 = 'bx;

assign zext_ln18_fu_378_p1 = lshr_ln1_fu_368_p4;

endmodule //llama_layer_llama_layer_Pipeline_VITIS_LOOP_19_13
