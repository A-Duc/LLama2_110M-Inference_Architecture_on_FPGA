...
module llama_layer_matmul_1_Loop_VITIS_LOOP_112_1_proc_Pipeline_VITIS_LOOP_112_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln112_fu_95_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln112_fu_95_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln112_fu_89_p2 = (ap_sig_allocacmp_i_8 + 10'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001_grp1 = ((res_stream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((m_axi_gmem1_0_WREADY == 1'b0) | (res_stream_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((m_axi_gmem1_0_WREADY == 1'b0) | (res_stream_empty_n == 1'b0)));
end

assign ap_block_pp0_stage0_grp1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((m_axi_gmem1_0_WREADY == 1'b0) | (res_stream_empty_n == 1'b0)));
end
...
assign icmp_ln112_fu_95_p2 = ((ap_sig_allocacmp_i_8 == 10'd768) ? 1'b1 : 1'b0);
...
assign m_axi_gmem1_0_WDATA = res_stream_dout;
...
endmodule //llama_layer_matmul_1_Loop_VITIS_LOOP_112_1_proc_Pipeline_VITIS_LOOP_112_1
