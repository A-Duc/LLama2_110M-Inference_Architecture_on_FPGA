...
module llama_layer_kernel_mhsa_1_Block_entry_current_token_fb_proc_Outline_SOFTMAX_HEADS (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [3:0] add_ln110_fu_130_p2;
reg   [3:0] add_ln110_reg_188;
...
llama_layer_kernel_softmax grp_kernel_softmax_fu_104(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((~(h_1_load_fu_127_p1 == 4'd0) & ~(h_1_load_fu_127_p1 == 4'd1) & ~(h_1_load_fu_127_p1 == 4'd2) & ~(h_1_load_fu_127_p1 == 4'd3) & ~(h_1_load_fu_127_p1 == 4'd4) & ~(h_1_load_fu_127_p1 == 4'd5) & ~(h_1_load_fu_127_p1 == 4'd6) & ~(h_1_load_fu_127_p1 == 4'd7) & ~(h_1_load_fu_127_p1 == 4'd8) & ~(h_1_load_fu_127_p1 == 4'd9) & ~(h_1_load_fu_127_p1 == 4'd10) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln110_fu_136_p2 == 1'd0)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln110_fu_136_p2 == 1'd0) & (h_1_load_fu_127_p1 == 4'd0)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln110_fu_136_p2 == 1'd0) & (h_1_load_fu_127_p1 == 4'd1)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln110_fu_136_p2 == 1'd0) & (h_1_load_fu_127_p1 == 4'd2)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln110_fu_136_p2 == 1'd0) & (h_1_load_fu_127_p1 == 4'd3)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln110_fu_136_p2 == 1'd0) & (h_1_load_fu_127_p1 == 4'd4)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln110_fu_136_p2 == 1'd0) & (h_1_load_fu_127_p1 == 4'd5)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln110_fu_136_p2 
    == 1'd0) & (h_1_load_fu_127_p1 == 4'd6)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln110_fu_136_p2 == 1'd0) & (h_1_load_fu_127_p1 == 4'd7)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln110_fu_136_p2 == 1'd0) & (h_1_load_fu_127_p1 == 4'd8)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln110_fu_136_p2 == 1'd0) & (h_1_load_fu_127_p1 == 4'd9)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln110_fu_136_p2 == 1'd0) & (h_1_load_fu_127_p1 == 4'd10)))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state2) & (icmp_ln110_fu_136_p2 == 1'd1)) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln110_fu_136_p2 == 1'd1))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
assign add_ln110_fu_130_p2 = (h_fu_94 + 4'd1);
...
assign att_0_address0 = grp_kernel_softmax_fu_104_i_vec_address0;

assign att_0_d0 = grp_kernel_softmax_fu_104_i_vec_d0;
...
assign icmp_ln110_fu_136_p2 = ((h_fu_94 == 4'd12) ? 1'b1 : 1'b0);

endmodule //llama_layer_kernel_mhsa_1_Block_entry_current_token_fb_proc_Outline_SOFTMAX_HEADS
