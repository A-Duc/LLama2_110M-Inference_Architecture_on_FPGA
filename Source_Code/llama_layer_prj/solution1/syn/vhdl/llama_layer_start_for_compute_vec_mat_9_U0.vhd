...
entity llama_layer_start_for_compute_vec_mat_9_U0 is 
    generic (
...
architecture rtl of llama_layer_start_for_compute_vec_mat_9_U0 is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component llama_layer_start_for_compute_vec_mat_9_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_llama_layer_start_for_compute_vec_mat_9_U0_ShiftReg : llama_layer_start_for_compute_vec_mat_9_U0_ShiftReg
    generic map (
...
entity llama_layer_start_for_compute_vec_mat_9_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end llama_layer_start_for_compute_vec_mat_9_U0_ShiftReg;

architecture rtl of llama_layer_start_for_compute_vec_mat_9_U0_ShiftReg is
