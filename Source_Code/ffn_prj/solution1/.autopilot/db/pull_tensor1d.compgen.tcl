...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_tsor \
    op interface \
    ports { tsor_dout { I 64 vector } tsor_empty_n { I 1 bit } tsor_read { O 1 bit } tsor_num_data_valid { I 3 vector } tsor_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { res_strm_dout { I 32 vector } res_strm_empty_n { I 1 bit } res_strm_read { O 1 bit } res_strm_num_data_valid { I 7 vector } res_strm_fifo_cap { I 7 vector } } \
} "
}
...
set InstName FFN_flow_control_loop_pipe_U
set CompName FFN_flow_control_loop_pipe
