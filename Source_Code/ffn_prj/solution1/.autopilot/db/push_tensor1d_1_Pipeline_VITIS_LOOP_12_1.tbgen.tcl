set moduleName push_tensor1d_1_Pipeline_VITIS_LOOP_12_1
set isTopModule 0
...
set cdfgNum 24
set C_modelName {push_tensor1d.1_Pipeline_VITIS_LOOP_12_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ sext_ln12 int 62 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "i_vec","offset": { "type": "dynamic","port_name": "i_vec","bundle": "control_r"},"direction": "READONLY"},{"cName": "o_vec","offset": { "type": "dynamic","port_name": "o_vec","bundle": "control_r"},"direction": "WRITEONLY"},{"cName": "W1_vec","offset": { "type": "dynamic","port_name": "W1_vec","bundle": "control_r"},"direction": "READONLY"},{"cName": "W2_vec","offset": { "type": "dynamic","port_name": "W2_vec","bundle": "control_r"},"direction": "READONLY"},{"cName": "W3_vec","offset": { "type": "dynamic","port_name": "W3_vec","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln12", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ x_strm_din sc_out sc_lv 32 signal 2 } 
	{ x_strm_full_n sc_in sc_logic 1 signal 2 } 
	{ x_strm_write sc_out sc_logic 1 signal 2 } 
	{ sext_ln12 sc_in sc_lv 62 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln12", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln12", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln12 { ap_none {  { sext_ln12 in_data 0 62 } } }
