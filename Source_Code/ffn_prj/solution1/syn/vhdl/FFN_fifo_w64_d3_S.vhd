...
architecture rtl of FFN_fifo_w64_d3_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component FFN_fifo_w64_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_FFN_fifo_w64_d3_S_ShiftReg : FFN_fifo_w64_d3_S_ShiftReg
    generic map (
...
entity FFN_fifo_w64_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end FFN_fifo_w64_d3_S_ShiftReg;

architecture rtl of FFN_fifo_w64_d3_S_ShiftReg is
