...
entity FFN_push_tensor1d_Pipeline_VITIS_LOOP_12_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of FFN_push_tensor1d_Pipeline_VITIS_LOOP_12_1 is 
...
begin
    ...
    add_ln12_fu_83_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv10_1));
    ...
    icmp_ln12_fu_89_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv10_300) else "0";
