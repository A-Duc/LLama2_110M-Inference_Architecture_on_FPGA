...
FFN_fexp_32ns_32ns_32_9_med_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fexp_32ns_32ns_32_9_med_dsp_1_U46(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(32'd0),
    .din1(grp_fu_74_p1),
...
FFN_dadd_64ns_64ns_64_5_no_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dadd_64ns_64ns_64_5_no_dsp_1_U47(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(conv1_reg_227),
...
FFN_ddiv_64ns_64ns_64_30_no_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
ddiv_64ns_64ns_64_30_no_dsp_1_U49(
    .clk(ap_clk),
    .reset(ap_rst),
...
assign i_4_fu_105_p2 = (ap_sig_allocacmp_i_3 + 12'd1);

assign icmp_ln52_fu_111_p2 = ((ap_sig_allocacmp_i_3 == 12'd3072) ? 1'b1 : 1'b0);
