...
module FFN_push_tensor1d_1_Pipeline_VITIS_LOOP_12_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln12_fu_89_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln12_fu_89_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln12_fu_83_p2 = (ap_sig_allocacmp_i_2 + 10'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp1 = ((x_strm_full_n == 1'b0) | (m_axi_gmem_0_RVALID == 1'b0));
end
...
assign icmp_ln12_fu_89_p2 = ((ap_sig_allocacmp_i_2 == 10'd768) ? 1'b1 : 1'b0);
...
assign x_strm_din = m_axi_gmem_0_RDATA;

assign x_strm_write = x_strm_write_local;

endmodule //FFN_push_tensor1d_1_Pipeline_VITIS_LOOP_12_1
