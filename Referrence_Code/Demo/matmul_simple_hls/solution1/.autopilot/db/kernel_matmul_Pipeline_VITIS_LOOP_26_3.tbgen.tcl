set moduleName kernel_matmul_Pipeline_VITIS_LOOP_26_3
set isTopModule 0
...
set cdfgNum 5
set C_modelName {kernel_matmul_Pipeline_VITIS_LOOP_26_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict vec_local { MEM_WIDTH 32 MEM_SIZE 3072 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem1 int 32 regular {axi_master 0}  }
	{ select_ln17_1 int 32 regular  }
	{ vec_local float 32 regular {array 768 { 1 3 } 1 1 }  }
...
set Spec2ImplPortList { 
	...
	vec_local { ap_memory {  { vec_local_address0 mem_address 1 10 }  { vec_local_ce0 mem_ce 1 1 }  { vec_local_q0 mem_dout 0 32 } } }
	phi_mul { ap_none {  { phi_mul in_data 0 62 } } }
	i_mat { ap_none {  { i_mat in_data 0 64 } } }
